...
소프트웨어는 마치 생명체와 같아서, 시간이 흐르면 그 생애를 마감합니다. 우리 개발자의 역할은 제 몫을 다한 소프트웨어를 조심스럽게 분해하여 새로운 소프트웨어에 생명을 불어넣는 것입니다.
...
<img src="/images/20240705-edswc/example.png" height="500"/>
